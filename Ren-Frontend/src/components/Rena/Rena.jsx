...
const Rena = () => {
  ...
  const handleButtonClick = (option) => {
    ...
    setTimeout(() => {
      ...
      switch (option) {
        case "Which cultural events are scheduled for the third day?":
          botResponse = "Cultural events scheduled for the third day include: <br> 1. Navras <br> 2. Kavya <br> 3. Shor Bazzar <br> 4. Bootstrapping <br> 5. Celebrity Night";
          break;
        case "What safety measures are in place for attendees?":
          botResponse = "Safety measures for attendees include: <br> 1. Security personnel at all entrances and exits. <br> 2. First aid stations located throughout the venue. <br> 3. Emergency evacuation plans in place. <br> 4. Crowd control measures to ensure smooth movement.";
          break;
        case "What are the timings for each event?":
          botResponse = "Event timings vary by day and event. Please specify which day or event you are interested in for detailed timings.";
          break;
        case "Can you tell me about any cultural events related to dance?":
          botResponse = "Cultural events related to dance include: <br> 1. Footloose (Solo Dance) <br> 2. Battle Mania (Street Dance) <br> 3. Bootstrapping (Group Dance)";
          break;
        case "Describe the theme for Ren 2025?":
          botResponse = "The theme for Renaissance 2025 is 'Innovation and Creativity: Shaping the Future'. The fest aims to showcase the best of technology, culture, and innovation, bringing together students from across the country to celebrate talent and creativity.";
          break;
        case "Can you provide information about the fest's history or previous editions?":
          botResponse = "Renaissance is the annual techno-cultural fest of JECRC, held every year in March. Over the years, it has grown into one of the largest college fests in Rajasthan, attracting participants from over 97 premier institutions nationwide. The fest has hosted renowned personalities like Lt. Jagjit Singh, Shubha Mudgal, Euphoria, and many more.";
          break;
        case "What is the main purpose of this chatbot at the fest?":
          botResponse = "The main purpose of this chatbot is to assist attendees with information about the fest, including event details, schedules, safety measures, and more. It aims to provide quick and accurate responses to enhance the overall experience of the fest.";
          break;
        case "Can you suggest some must attend events?":
          botResponse = "Some must-attend events at Renaissance 2025 include: <br> 1. Rockathon (Battle of Bands) <br> 2. DJ War <br> 3. Celebrity Night <br> 4. Footloose (Solo Dance) <br> 5. Code Zeal (Coding Competition)";
          break;
        case "Can you tell me about any tech events taking place on the second day?":
          botResponse = "Technical events on the second day include: <br> 1. Code Zeal <br> 2. Tech Hunt <br> 3. Brain Quest <br> 4. Robo Soccer <br> 5. Programmer's Playground";
          break;
        case "Can you tell me about any tech events related to coding?":
          botResponse = "Tech events related to coding include: <br> 1. Code Zeal <br> 2. Programmer's Playground <br> 3. Web Bro <br> 4. Subito <br> 5. Knowledge Knockout";
          break;
        case "Can you tell me about any splash events taking place on first day?":
          botResponse = "Splash events on the first day include: <br> 1. Gully Cricket <br> 2. Tug of War <br> 3. Lan Gaming <br> 4. IPL Auction <br> 5. Relay Race";
          break;
        case "Can you tell me about any sports related events?":
          botResponse = "Sports-related events include: <br> 1. Gully Cricket <br> 2. Half Court Basketball <br> 3. Tug of War <br> 4. Arm Wrestling <br> 5. Relay Race";
          break;
        case "Who are the celebrity guests attending the fest?":
          botResponse = "Celebrity guests attending Renaissance 2025 include: <br> 1. Ranbir Kapoor <br> 2. Abhishek Bachchan <br> 3. Millind Gaba <br> 4. Harsh Gujral <br> 5. Arjun Kanungo";
          break;
        case "What are the main attractions of the fest?":
          botResponse = "The main attractions of Renaissance 2025 include: <br> 1. Celebrity Night <br> 2. Rockathon (Battle of Bands) <br> 3. DJ War <br> 4. Footloose (Solo Dance) <br> 5. Code Zeal (Coding Competition)";
          break;
        case "Will there be any celebrity performance during the fest?":
          botResponse = "Yes, there will be celebrity performances during the fest. Some of the confirmed performances include: <br> 1. Ranbir Kapoor <br> 2. Millind Gaba <br> 3. Arjun Kanungo";
          break;
        case "Which music related events are taking place during the fest?":
          botResponse = "Music-related events during the fest include: <br> 1. Rockathon (Battle of Bands) <br> 2. DJ War <br> 3. Beat The Beats (Solo Instrumental) <br> 4. Guest Band Performance";
          break;
        case "Are there any cooking related events taking place?":
          botResponse = "Yes, there is a cooking-related event called 'Masterchef Challenge', where participants showcase their culinary skills.";
          break;
        case "Can you tell me about the poetry competitions that are taking place on the third day of the fest?":
          botResponse = "Poetry competitions on the third day include: <br> 1. Kavya (Slam Poetry) <br> 2. Navras (Mono Act)";
          break;
        default:
          // If the question is not predefined, proceed with the existing logic
          switch (option) {
            ...
            case "Technical Events":
              ...
              14. Robo Soccer <br> \
              15. Slowest Roller Coaster with Paper <br> \
